namespace Foreman
{
    ...
    public partial class EnableDisableItemsForm : Form
    {
        ...
        public EnableDisableItemsForm()
        {
            ...
            AssemblerSelectionBox.Items.AddRange(DataCache.Assemblers.Values.ToArray<object>());
            ...
            MinerSelectionBox.Items.AddRange(DataCache.Miners.Values.ToArray<object>());
            ...
            ModuleSelectionBox.Items.AddRange(DataCache.Modules.Values.ToArray<object>());
            ...
            ModSelectionBox.Items.AddRange(DataCache.Mods.ToArray<object>());
