namespace Foreman
{
    ...
    public class LinkElement : GraphElement
    {
        ...
        public ProductionNode Supplier => DisplayedLink.Supplier;

        public ProductionNode Consumer => DisplayedLink.Consumer;

        public NodeElement SupplierElement => Parent.GetElementForNode(Supplier);

        public NodeElement ConsumerElement => Parent.GetElementForNode(Consumer);

        public Item Item => DisplayedLink.Item;
